                    ...
                    <div className='homepage_block' id='charts_container'>
                        <div className='homepage_block' id='summary_panel'>
                            ...
                            <div className='summary_description'>
                                <Typography sx={{color: '#D5D7E0'}} variant='body2'>This is your hompage, after you add teams in the 'browse teams' tab they will apear here. At that point you can take a deeper look at upcoming events as well as see an overall prediction for all upcoming events.</Typography>
                            </div>
                        </div>
                            ...
                            <div className='main_chart_container'>  
                                <div className='chart_box' id='team_chart_box'>
                                    ...
                                    <div className='pie_chart'>
                                        <PieChartComponent data={getTeam(chartteam)} innerRadius={isBigScreen() ? 60 : 40} outerRadius={isBigScreen() ? 85 : 60} activeIndex={activeIndex} setactiveIndex={setactiveIndex}/>
                                    </div>
                                ...
                                <div className='chart_box' id='results_chart_box'>
                                    ...
                                    <div className='pie_chart'>
                                        <PieChartComponent data={resultData} innerRadius={isBigScreen() ? 60 : 40} outerRadius={isBigScreen() ? 85 : 60} activeIndex={resultsactiveIndex} setactiveIndex={setresultsactiveIndex}/>
                                    </div>
                                    <div className='chart_description'>
